...
namespace LAppDefine
{
    ...
    //new add
     //csmChar ** ModelDir;               ///< モデルを配置したディレクトリ名の配列. ディレクトリ名とmodel3.jsonの名前を一致させておく.
    // csmInt32 ModelDirSize;             ///< モデルディレクトリ配列のサイズ
     //extern const int MAX_MODELS;

    extern QStringList ModelDir;
    extern void addModel(const QString modelPath);
}
